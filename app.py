...
friends_info = {
    ...
    "timokha": ("Тимофка", "Всегда на связи", "timokha.jpg", [("Steam", "#")]),
...
# ИСПРАВЛЕНО: Добавлено <page_name>
...
# ИСПРАВЛЕНО: Добавлено <recipient>
...
# ИСПРАВЛЕНО: Добавлено <int:note_id>
...
def delete_note(note_id):
    ...
    if password == "1234": # Пароль для удаления
        db.session.delete(note)
        db.session.commit()
    return redirect(url_for('show_page', page_name=target))
